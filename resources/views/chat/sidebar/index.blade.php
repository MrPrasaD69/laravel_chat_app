        ...
        <div class="col-md-12">
            <div class="tab-content">
                ...
                <div class="tab-pane fade" id="members">
                    ...
                    <div class="contacts">
                        ...
                        <div class="list-group" id="contacts" role="tablist">
                            ...
                            <a href="#" class="filterMembers all online contact" data-toggle="list">
                                <img class="avatar-md" src="{{ url('assets/img/avatars/avatar-male-1.jpg') }}" data-toggle="tooltip" data-placement="top" title="Michael" alt="avatar">
                                <div class="status">
                                    <i class="material-icons online">fiber_manual_record</i>
                                </div>
                                <div class="data">
                    ...
                    <div class="discussions">
                        ...
                        <div class="list-group" id="chats" role="tablist">
                            ...
                            <a href="#list-chat" class="filterDiscussions all read single" id="list-chat-list2" data-toggle="list" role="tab">
                                <img class="avatar-md" src="{{ url('assets/img/avatars/avatar-female-2.jpg')}}" data-toggle="tooltip" data-placement="top" title="Lean" alt="avatar">
                                <div class="status">
                                    <i class="material-icons offline">fiber_manual_record</i>
                                </div>
                                <div class="data">
                ...
                <div class="tab-pane fade" id="settings">
                    <div class="settings">
                        <div class="profile">
                            <img class="avatar-xl" src="assets/img/avatars/avatar-male-1.jpg" alt="avatar">
                            ...
                            <div class="category">
                                ...
                                <div class="collapse" id="collapseOne" aria-labelledby="headingOne" data-parent="#accordionSettings">
                                    <div class="content">
                                        <div class="upload">
                                            <div class="data">
                                                <img class="avatar-xl" src="assets/img/avatars/avatar-male-1.jpg" alt="image">
                                                <label>
                                                    <input type="file">
